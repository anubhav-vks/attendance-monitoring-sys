...
firebase_admin.initialize_app(cred, {
    'databaseURL' : "https://attendancesystemcv-default-rtdb.firebaseio.com/",
    'storageBucket' : "attendancesystemcv.appspot.com"
})
...
# imgBackground = cv2.imread('Resources/newbg.jpg')
...
while True:
    ...
    if faceCurFrame:
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            #If the new face is not in the database then alert       
            else:
                # print("Intruder alert")
                y1, x2, y2, x1 = faceLoc
                y1, x2, y2, x1 = y1 * 4, x2 * 4, y2 * 4, x1 * 4
                bbox = 55 + x1, 162 + y1, x2 - x1, y2 - y1
                cvzone.putTextRect(imgBackground, "Intruder Detected", (55, 162), colorR=(0,0,255))
                imgBackground = cvzone.cornerRect(imgBackground, bbox, rt=0, colorC= (0,0,255), colorR=(0,0,255))
